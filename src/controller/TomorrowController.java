...
public class TomorrowController implements Initializable{
	...
	/**
	 * Event handler for addTaskTF text field when clicked.
	 * Need to differentiate between valid and invalid inputs so that unnamed tasks are not created.
	 * Also needs to clear the text field after successfully creating a task.
	 */
	@FXML
